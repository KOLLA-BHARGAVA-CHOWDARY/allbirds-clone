    ...
    return(
        <article className="relative group overflow-hidden rounded-2xl">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                ...
                <button className="absolute top-[50%] border rounded-2xl px-4 py-2 border-white text-white text-xs font-bold opacity-0 group-hover:opacity-100 transform translate-y-5 group-hover:translate-y-0 transition-all duration-500">
                    SHOP WOMEN
                </button>
            </div>
        </article>
